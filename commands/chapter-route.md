---
description: Route a task to a chapter's specialists. Usage: /agentic-chapters:chapter-route <discipline> <task>
argument-hint: <discipline> <task>
---

Invoke the orchestrator (via the Agent tool, `subagent_type: "agentic-chapters:agent-orchestrator"`) with this task:
